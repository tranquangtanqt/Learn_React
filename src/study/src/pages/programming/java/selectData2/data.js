...
spring.jpa.database-platform=org.hibernate.dialect.H2Dialect`,
	...
	data: `CREATE TABLE IF NOT EXISTS TBL_BOOK(
...
INSERT INTO TBL_BOOK (id, title, isbn, publisher) VALUES
  ...
  (3, 'title_3', 'isbn_3', 'publisher_3');`,
    ...
    book: `package com.learning.connect.h2.database.entity;
...
public class Book implements Serializable {
    ...
    apiResponse: `package com.learning.connect.h2.database.dto;
...
public class ApiResponse<T> extends ResponseEntity {
	...
	bookDto: `package com.learning.connect.h2.database.dto;
...
public class BookDto implements Serializable{
    ...
    iBookRepository: `package com.learning.connect.h2.database.repository;
...
public interface IBookRepository extends JpaRepository<Book, Long>{
    ...
    bookService : `package com.learning.connect.h2.database.services;
...
public class BookService {
    ...
    bookController: `package com.learning.connect.h2.database.controller;
...
public class BookController {
    ...
    connectH2DatabaseApplication: `package com.learning.connect.h2.database;
