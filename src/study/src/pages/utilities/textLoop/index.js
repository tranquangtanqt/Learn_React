    ...
    const renderText = () => {
        ...
        if(isNaN(start)){
            ...
            for (let i = startNumber; i <= endNumber; i++) {
                let str = replaceAll(input.val(), "###name###", String.fromCharCode(i));
    ...
    return (
        <MasterLayout>
            <form>
                ...
                <Row justify="start">
                    <Col span={24}>
                        <textarea value={input} onChange={(e) => setInput(e.target.value)} style={{height: 200, width: "100%"}} />
                    </Col>
                </Row>
                ...
                <Divider orientation="left"><Button type="primary" onClick={renderText}>Render text</Button></Divider>
